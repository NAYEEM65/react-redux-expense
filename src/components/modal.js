...
export default function Modal() {
    ...
    return (
        <>
            ...
            >
                <div className="relative p-4 w-full max-w-md h-full md:h-auto my-0 mx-auto transition duration-150 ease-out md:ease-in">
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        >
                            <svg
                                aria-hidden="true"
                                className="w-5 h-5 bg-orange-600 rounded"
